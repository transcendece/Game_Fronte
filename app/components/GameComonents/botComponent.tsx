...
const BotComponent : React.FC<BotMap> = (prop) => {
    ...
    return (
        <div className="flex flex-row justify-center items-center w-full h-full flex-col">
            <div className="flex flex-row items-center justify-end">
                 <Score avatar="/_next/image?url=%2Fbatman.png&w=3840&q=75" name="BATMAN" score={Infinity} />
            </div>
            <div 
                ref={gameDiv} 
                className="flex w-[60%] h-[60%] justify-center blue ">
            </div>
            ...
            type="button" onClick={()=>prop.setBotGame(false)}>Cencel</button>
        </div>
    );
};
